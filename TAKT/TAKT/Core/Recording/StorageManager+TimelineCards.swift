  ...
  func buildOnboardingSummary() -> String {
    ...
    case .local:
      ...
      if localEngine == "lmstudio" {
        ...
        return
          "You successfully installed TAKT with Ollama — your data stays 100% on your device. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"
      }

    case .dayflow:
      return
        "You successfully installed TAKT with TAKT Pro. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"

    case .openAICompatible:
      return
        "You successfully installed TAKT with your OpenAI-compatible provider. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"

    case nil:
      return
        "You successfully installed TAKT. Come back in 30 minutes to see your first real activity card! ✨ (This is a sample card, so you can see what your timeline will look like.)"
    }
  }
